...
export const Section5ComponentInner = ({ eventList }) => {
  return (
    <>
      <section id="trigger5" className="trigger relative w-full flex flex-col">
        <Container className="my-10">
          <div className="relative w-full flex flex-col items-center sm:border  border-white rounded-2xl sm:px-12 sm:py-12 md:p-20">
            ...
            <FancyLink
              className={`w-fit py-4 px-6 text-sm text-white font-default tracking-widest transition-all ease-linear hover:bg-white border hover:text-black border-white rounded-xl`}
