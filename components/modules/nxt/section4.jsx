    ...
    <section className="relative w-full">
      <div id="enter-collab" className="relative z-10 top-0 w-full h-screen ">
        ...
        >
          ...
          >
            <span className="text-[#BEC29D] mb-7 break-all max-w-[450px] whitespace-pre-line text-center font-funkturm text-m-additionalTitle leading-full drop-shadow-collaborators md:hidden">
