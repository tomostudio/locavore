    ...
    <Layout>
      ...
      {loading ? (
        <div className="h-screen w-screen flex flex-col justify-center items-center bg-[#BFC29D]">
          ...
          <span className="uppercase block font-default mt-5 text-xs">
            LOADING
          </span>
        </div>
      ) : (
        <>
          ...
          <div
            id="NXTbackground"
            className={`background fixed -z-2 w-full pointer-events-none transition-colors duration-[2000ms] h-[125vh]`}
