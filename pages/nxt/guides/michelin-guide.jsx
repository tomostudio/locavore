          ...
          <Container className="max-md:px-6">
            <article className="max-w-[800px] w-full mx-auto text-black">
              ...
              <div className="my-14 flex justify-center">
                <FancyLink
                  blank
                  destination="https://revasi.net/restaurants/locavorenxt/availability?utm_source=website&utm_medium=referral&utm_campaign=is-locavore-nxt-a-michelin-starred-restaurant"
