...
const STATIC_ROUTES = [
  ...
  { path: "/nxt/guides/reservation-guide", priority: 0.8, changefreq: "monthly" },
  { path: "/nxt/guides/tasting-menu-guide", priority: 0.8, changefreq: "monthly" },
  { path: "/nxt/guides/michelin-guide", priority: 0.8, changefreq: "monthly" },
