              ...
              <div className="w-full h-full bg-white rounded-2xl py-14 setflex-center">
                <div className="w-content space-y-10">
                  ...
                  <p className="px-paddingContent">
                    ...
                    essentially unchanged. It was popularise in the 1960s with
                    the release of Letraset sheets containing Lorem Ipsum
                    passages, and more recently with desktop publishing software
                    like Aldus PageMaker including versions of Lorem Ipsum.
                    Contrary to popular belief, Lorem Ipsum is not simply random
                    text. Richard McClintock, a Latin professor at
                    ...
                    by Cicero, written in 45 BC. Letraset sheets containing
                    Lorem Ipsum passages.
                  </p>
                  <p className="font-title font-bold uppercase px-paddingContent">
                    It has roots in a piece of classical west Latin literature
                    from 45 BC, making it over 2000 years old ever since.
                  </p>
                  <p className="px-paddingContent">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry. Lorem Ipsum has been the industry's
                    ...
                    the release of Letraset sheets containing Lorem Ipsum
                    passages, and more recently with desktop publishing software
                    like Aldus Page Maker including versions of Lorem Ipsum.
                  </p>
                  {/* Image */}
            ...
            <div className="w-full h-auto px-8 py-14 setflex-center">
              <div className="w-content space-y-10">
                ...
                <p className="px-paddingContent">
                  ...
                  like Aldus PageMaker including versions of Lorem Ipsum.
                  Contrary to popular belief, Lorem Ipsum is not simply random
                  text. Richard McClintock, a Latin professor at Hampden-Sydney
                ...
                <p className="font-title font-bold text-3xl">
                  ...
                  form, or randomised words which don't look even slightly
                  believable. If you are going to use a passage of Lorem Ipsum,
                  you need to be sure there isn't anything hidden in the middle
                  of text.
                </p>
                <p className="px-paddingContent">
              ...
              <div className="w-full h-full bg-white rounded-2xl py-14 setflex-center">
                <div className="w-content space-y-10">
                  ...
                  <p className="px-paddingContent">
                    ...
                    including versions of Lorem Ipsum. Contrary to popular
                    belief, Lorem Ipsum is not simply random text. Richard
                    McClintock, a Latin professor at Hampden-Sydney College in
                    Virginia, looked up one of the more obscure Latin words,
                    consectetur, from a Lorem Ipsum passage, and going through
                    the cites of the word in classical literature, discovered
                    the undoubtable source of material.
                  </p>
                  {/* Image */}
                  <div className="w-full h-auto px-paddingContent">
